...
#from funlog.portlet.googlead import GoogleAdMessageFactory as _


class IGoogleAd(IPortletDataProvider):
    """A portlet
...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('googlead.pt')
...
class AddForm(base.AddForm):
    ...
    """
    form_fields = form.Fields(IGoogleAd)
